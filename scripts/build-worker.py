...
filter_worker_elm_js_string = filter_worker_elm_js_string.replace("`", "\`")

filter_worker_js_file = open("src/filter-worker.js",'r')
filter_worker_js_string = filter_worker_js_file.read()

filter_worker_template_js_file = open("src/filter-worker-template.js",'r')
...
filter_worker_bundle_js_file = open("src/gen/filter-worker-bundle.js",'w')
