module Examples.SelectedOptionWithAsyncOptions exposing (suite)
...
suite : Test
suite =
    describe "Example: selected-option-with-async-options"
        [ test "selected value remains selected after async options arrive" <|
            \_ ->
                start
