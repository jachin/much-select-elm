                ...
                case option of
                    Option display (OptionLabel labelStr _) optionValue _ _ ->
                        case display of
                            ...
                            OptionSelected ->
                                div [ class "value", mousedownPreventDefaultAndStopPropagation (ToggleSelectedValueHighlight optionValue) ] [ text labelStr ]

                            OptionSelectedHighlighted ->
                                div
                                    [ classList [ ( "value", True ), ( "selected-value", True ) ]
                                    , mousedownPreventDefaultAndStopPropagation (ToggleSelectedValueHighlight optionValue)
                                    ]
                                    [ text labelStr ]
