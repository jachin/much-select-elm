...
var $author$project$Option$optionListContainsOptionWithValueString = F2(
...
var $author$project$Option$selectOptionInListByValueStringWithIndex = F3(
	function (index, valueString, options) {
		return A3(
			$author$project$Option$selectOptionInListByOptionValueWithIndex,
			index,
			$author$project$Option$OptionValue(valueString),
			options);
	});
				...
				while (true) {
					if (!valueStrings.b) {
						...
						if (!valueStrings.b.b) {
							...
							return A2($author$project$Option$optionListContainsOptionWithValueString, valueString, options_) ? A3($author$project$Option$selectOptionInListByValueStringWithIndex, index, valueString, options_) : _Utils_ap(
								options_,
								_List_fromArray(
									[
							...
							if (A2($author$project$Option$optionListContainsOptionWithValueString, valueString, options_)) {
								var $temp$index = index + 1,
									...
									$temp$options_ = A3($author$project$Option$selectOptionInListByValueStringWithIndex, index, valueString, options_);
								index = $temp$index;
...
var $author$project$Main$MulitSelectAttributeChanged = function (a) {
	return {$: 'MulitSelectAttributeChanged', a: a};
};
...
var $author$project$Option$setOptionDisplaySelectedIndex = F2(
		...
		switch (option.$) {
			case 'Option':
				...
				return A2(
					...
					A2($author$project$Option$setOptionDisplaySelectedIndex, selectedIndex, optionDisplay),
					option);
			case 'CustomOption':
				var optionDisplay = option.a;
				return A2(
			...
			return A2(
				...
				function (option) {
					...
					return A2(
						...
						$elm$core$Maybe$Just(
							A4($author$project$OptionSearchFilter$new, searchResult.labelMatch.score + searchResult.descriptionMatch.score, searchResult, labelTokens, descriptionTokens)),
						option);
				},
				options);
		}
		...
		switch (msg.$) {
			...
			case 'DropdownMouseOverOption':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{options: updateOptions, optionsForTheDropdown: optionsForTheDropdown}),
					$elm$core$Platform$Cmd$none);
			case 'DropdownMouseOutOption':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{options: updatedOptions, optionsForTheDropdown: optionsForTheDropdown}),
					$elm$core$Platform$Cmd$none);
			...
			case 'SearchInputOnInput':
				...
				return _Utils_Tuple2(
					A4($author$project$Main$updateModelWithSearchStringChanges, model.maxDropdownItems, searchString, model.options, model),
			...
			case 'EscapeKeyInInputFilter':
				return _Utils_Tuple2(
					A4($author$project$Main$updateModelWithSearchStringChanges, model.maxDropdownItems, '', model.options, model),
					$author$project$Ports$blurInput(_Utils_Tuple0));
...
var $author$project$Main$dropdown = function (model) {
	...
	var dropdownFooterHtml = (_Utils_cmp(
		$elm$core$List$length(model.optionsForTheDropdown),
		$elm$core$List$length(model.options)) < 0) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				'showing ' + ($elm$core$String$fromInt(
					$elm$core$List$length(model.optionsForTheDropdown)) + (' of ' + ($elm$core$String$fromInt(
					$elm$core$List$length(model.options)) + ' options'))))
			])) : $elm$html$Html$text('');
	var dropdownCss = _List_fromArray(
		[
			...
			$elm$html$Html$Attributes$style,
			'top',
			$elm$core$String$fromFloat(model.valueCasingHeight) + 'px'),
			A2(
			$elm$html$Html$Attributes$style,
			'width',
			$elm$core$String$fromFloat(model.valueCasingWidth) + 'px')
		]);
	return model.disabled ? $elm$html$Html$text('') : ((model.showDropdown && (!$elm$core$List$isEmpty(optionsHtml))) ? A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
