...
})({"2dmRv":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "1204512211e881b9";
"use strict";
...
},{}],"eZRex":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _muchSelectJs = require("../src/much-select.js");
var _muchSelectJsDefault = parcelHelpers.interopDefault(_muchSelectJs);
var _eventLoggerJs = require("./event-logger.js");
var _eventLoggerJsDefault = parcelHelpers.interopDefault(_eventLoggerJs);
if (!customElements.get("much-select")) // Putting guard rails around this because browsers do not like
//  having the same custom element defined more than once.
window.customElements.define("much-select", _muchSelectJsDefault.default);
window.makeLogEventHandler = _eventLoggerJsDefault.default;

},{"../src/much-select.js":"dxsGj","./event-logger.js":"86qJK","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dxsGj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// noinspection ES6CheckImport
var _mainElm = require("./Main.elm");
var _asciiFoldJs = require("./ascii-fold.js");
var _asciiFoldJsDefault = parcelHelpers.interopDefault(_asciiFoldJs);
const buildOptionsFromSelectElement = (selectElement)=>{
    ...
    optionElements.forEach((optionElement, optionIndex)=>{
        ...
        option.labelClean = _asciiFoldJsDefault.default(optionElement.innerText);
        ...
        if (optionElement.dataset.description) {
            ...
            option.descriptionClean = _asciiFoldJsDefault.default(option.description);
        }
...
const stringToOptionObject = (str)=>({
        value: str,
        label: str,
        labelClean: _asciiFoldJsDefault.default(str)
    })
;
...
const cleanUpOption = (option)=>{
    if (typeof option === "string") return stringToOptionObject(option);
    if (typeof option === "number") return numberToOptionObject(option);
    if (typeof option === "object") {
        const optionMap = new Map();
        if (notNullOrUndefined(option.value)) optionMap.set("value", `${option.value}`);
        if (notNullOrUndefined(option.label)) optionMap.set("label", `${option.label}`);
        if (notNullOrUndefined(option.description)) optionMap.set("description", option.description);
        if (notNullOrUndefined(option.disabled)) optionMap.set("disabled", !!option.disabled);
        ...
        if (optionMap.has("value") && !optionMap.has("label")) return {
            ...
            labelClean: _asciiFoldJsDefault.default(optionMap.get("value")),
            value: optionMap.get("value"),
            description: optionMap.get("description"),
            descriptionClean: _asciiFoldJsDefault.default(optionMap.get("description")),
        ...
        if (optionMap.has("label") && !optionMap.has("value")) return {
            ...
            labelClean: _asciiFoldJsDefault.default(optionMap.get("label")),
...
class MuchSelect extends HTMLElement {
   ...
   */ updateDimensions() {
    ...
    buildFlags() {
        ...
        const selectElement = this.querySelector("select");
        if (selectElement) flags.optionsJson = JSON.stringify(buildOptionsFromSelectElement(selectElement));
    ...
    get appPromise() {
        ...
        this._appPromise = new Promise((resolve, reject)=>{
            if (this._app) resolve(this._app);
                ...
                // noinspection JSUnresolvedVariable
                this._app = _mainElm.Elm.Main.init({
                    flags,
                    node: elmDiv
                });
                resolve(this._app);
   ...
   * */ set selectedValueEncoding(value10) {
    ...
    updateOptions(options) {
        // noinspection JSUnresolvedVariable
        this.appPromise.then((app)=>app.ports.optionsChangedReceiver.send(cleanUpOptions(options))
        );
        this.updateDimensions();
    }
    addOption(option) {
    ...
    addOptions(options1) {
        // noinspection JSUnresolvedVariable
        this.appPromise.then((app)=>app.ports.addOptionsReceiver.send(cleanUpOptions(options1))
        );
        this.updateDimensions();
    }
    ...
    removeOptions(options2) {
        // noinspection JSUnresolvedVariable
        this.appPromise.then((app)=>app.ports.removeOptionsReceiver.send(cleanUpOptions(options2))
        );
        this.updateDimensions();
    }
    selectOption(option2) {
        // noinspection JSUnresolvedVariable
        this.appPromise.then((app)=>app.ports.selectOptionReceiver.send(cleanUpOption(option2))
        );
    }
    deselectOption(option3) {
        // noinspection JSUnresolvedVariable
        this.appPromise.then((app)=>app.ports.deselectOptionReceiver.send(cleanUpOption(option3))
        );
    }
    async getAllOptions() {
...
exports.default = MuchSelect;

},{"./Main.elm":"jaXzP","./ascii-fold.js":"hKb5G","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jaXzP":[function(require,module,exports) {
(function(scope) {
...
},{}],"hKb5G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _diacriticsJs = require("./diacritics.js");
var _diacriticsJsDefault = parcelHelpers.interopDefault(_diacriticsJs);
...
const asciiFold = buildAsciiFold(_diacriticsJsDefault.default);
exports.default = asciiFold;

},{"./diacritics.js":"2sahE","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2sahE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
diacritics.set("e", "[eÉéÈèÊêḘḙĚěĔĕẼẽḚḛẺẻĖėËëĒēȨȩĘęᶒɆɇȄȅẾếỀềỄễỂểḜḝḖḗḔḕȆȇẸẹỆệⱸᴇＥｅɘǝƏƐε]");
...
},{}],"86qJK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const makeLogEventHandler = (logElementId)=>{
    ...
    <td><code>${detailStr}</code></td>`;
        ...
        window.setTimeout(()=>{
            ...
            if (logItemNode.parentNode) logItemNode.parentNode.removeChild(logItemNode);
        }, 5000);
    };
    return logEvent;
};
exports.default = makeLogEventHandler;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["2dmRv","eZRex"], "eZRex", "parcelRequireee24")

//# sourceMappingURL=initial-value.11e881b9.js.map
