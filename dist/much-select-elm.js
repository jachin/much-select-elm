...
{
	if (region.d4.aF === region.dc.aF)
	{
		return 'on line ' + region.d4.aF;
	}
	return 'on lines ' + region.d4.aF + ' through ' + region.dc.aF;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aW: fragment, bq: host, a1: path, cv: port_, cB: protocol, bE: query};
	});
...
var $author$project$SelectionMode$defaultSelectionConfig = A3(
	...
	$author$project$OutputStyle$SingleSelectCustomHtml(
		{U: $author$project$OutputStyle$NoCustomOptions, V: 1, W: 0, K: 1, bu: $author$project$OutputStyle$NoLimitToDropdownItems, bH: $author$project$OutputStyle$NoMinimumToSearchStringLength, bI: 0}),
	_Utils_Tuple2(false, ''),
	1);
				...
				$author$project$OutputStyle$MultiSelectCustomHtml(
					{
						...
						W: dropdownStyle,
						K: eventsMode,
						bu: $author$project$OutputStyle$FixedMaxDropdownItems(
							$author$project$PositiveInt$new(maxDropdownItems)),
						bH: $author$project$OutputStyle$FixedSearchStringMinimumLength(
...
var $author$project$MuchSelect$init = function (flags) {
	...
	var optionSort = A2(
		$elm$core$Result$withDefault,
		0,
		$author$project$OptionSorting$stringToOptionSort(flags.S));
	var _v0 = function () {
	...
	var selectionConfig = A2(
		...
		$author$project$SelectionMode$makeSelectionConfig(flags.br)(flags.bi)(flags.bb)(flags.ba)(flags.bC)(flags.bD)(flags.bg)(flags.bk)(flags.bu)(flags.bJ)(flags.bH)(flags.bL)(valueTransformationAndValidation));
	var _v2 = function () {
		var _v3 = A2(
...
var $author$project$MuchSelect$SelectionConfigRequested = {$: 51};
...
var $author$project$Option$SearchResults = F3(
	function (optionSearchFilters, searchNonce, isClearingSearch) {
		return {ds: isClearingSearch, dR: optionSearchFilters, d0: searchNonce};
	});
var $author$project$OptionSearchFilter$OptionSearchFilter = F5(
	function (totalScore, bestScore, labelTokens, descriptionTokens, groupTokens) {
		return {bd: bestScore, c8: descriptionTokens, dj: groupTokens, dv: labelTokens, bP: totalScore};
	});
			...
			A3(
				...
				F2(
					function (value, searchFilter) {
						return {dA: searchFilter, bS: value};
					}),
				A2($elm$json$Json$Decode$field, 'value', $author$project$Option$valueDecoder),
				A2(
					$elm$json$Json$Decode$field,
...
var $author$project$SelectionMode$getCustomOptionHint = function (selectionConfig) {
	if (!selectionConfig.$) {
		...
		if (!singleSelectOutputStyle.$) {
			...
			var _v2 = singleSelectCustomHtmlFields.U;
			if (!_v2.$) {
		...
		if (!multiSelectOutputStyle.$) {
			...
			var _v4 = multiSelectCustomHtmlFields.U;
			if (!_v4.$) {
...
var $author$project$SelectionMode$getTransformAndValidate = function (selectionConfig) {
	if (!selectionConfig.$) {
		...
		if (!singleSelectOutputStyle.$) {
			var singleSelectCustomHtmlFields = singleSelectOutputStyle.a;
			return $author$project$OutputStyle$getTransformAndValidateFromCustomOptions(singleSelectCustomHtmlFields.U);
		} else {
		...
		if (!multiSelectOutputStyle.$) {
			var multiSelectCustomHtmlFields = multiSelectOutputStyle.a;
			return $author$project$OutputStyle$getTransformAndValidateFromCustomOptions(multiSelectCustomHtmlFields.U);
		} else {
...
var $author$project$SelectionMode$getSelectedItemPlacementMode = function (selectionConfig) {
	if (!selectionConfig.$) {
		...
		if (!singleSelectOutputStyle.$) {
			var singleSelectCustomHtmlFields = singleSelectOutputStyle.a;
			return singleSelectCustomHtmlFields.bI;
		} else {
			return 2;
		}
	} else {
...
var $author$project$OutputStyle$multiToSingle = function (multiSelectOutputStyle) {
	if (!multiSelectOutputStyle.$) {
		var multiSelectCustomHtmlFields = multiSelectOutputStyle.a;
		return $author$project$OutputStyle$SingleSelectCustomHtml(
			{U: multiSelectCustomHtmlFields.U, V: multiSelectCustomHtmlFields.V, W: multiSelectCustomHtmlFields.W, K: multiSelectCustomHtmlFields.K, bu: multiSelectCustomHtmlFields.bu, bH: multiSelectCustomHtmlFields.bH, bI: 0});
	} else {
		var eventsMode = multiSelectOutputStyle.a;
		var transformAndValidate = multiSelectOutputStyle.b;
...
var $author$project$OutputStyle$singleToMulti = function (singleSelectOutputStyle) {
	if (!singleSelectOutputStyle.$) {
		var singleSelectCustomHtmlFields = singleSelectOutputStyle.a;
		return $author$project$OutputStyle$MultiSelectCustomHtml(
			{U: singleSelectCustomHtmlFields.U, V: singleSelectCustomHtmlFields.V, W: singleSelectCustomHtmlFields.W, K: singleSelectCustomHtmlFields.K, bu: singleSelectCustomHtmlFields.bu, bH: singleSelectCustomHtmlFields.bH, bM: 1});
	} else {
		var eventsMode = singleSelectOutputStyle.a;
		var transformAndValidate = singleSelectOutputStyle.b;
...
var $author$project$OutputStyle$defaultMultiSelectCustomHtmlFields = {
	U: $author$project$OutputStyle$NoCustomOptions,
	V: 1,
	W: 0,
	K: 1,
				...
				if (!singleSelectOutputStyle.$) {
					...
					return A3(
						...
						A2(
							...
							fields.K,
							$author$project$OutputStyle$getTransformAndValidateFromCustomOptions(fields.U)),
						placeholder,
						interactionState);
				} else {
					return selectionConfig;
			...
			if (!singleSelectOutputStyle.$) {
				...
				return A3(
					...
					$author$project$OutputStyle$SingleSelectCustomHtml(
						_Utils_update(
							singleSelectCustomHtmlFields,
							{bH: newSearchStringMinimumLength})),
					placeholder,
					interactionState);
			} else {
				return selectionConfig;
		...
		if (!selectionConfig.$) {
			...
			if (!singleSelectOutputStyle.$) {
				...
				var newSingleSelectCustomFields = _Utils_update(
					singleSelectCustomHtmlFields,
					{
						U: A2($author$project$OutputStyle$setTransformAndValidateFromCustomOptions, newTransformAndValidate, singleSelectCustomHtmlFields.U)
					});
				return A3(
					$author$project$SelectionMode$SingleSelectConfig,
			...
			if (!multiSelectOutputStyle.$) {
				...
				var newMultiSelectCustomHtmlFields = _Utils_update(
					multiSelectCustomHtmlFields,
					{
						U: A2($author$project$OutputStyle$setTransformAndValidateFromCustomOptions, newTransformAndValidate, multiSelectCustomHtmlFields.U)
					});
				return A3(
					$author$project$SelectionMode$MultiSelectConfig,
...
var $author$project$MuchSelect$updateModelWithChangesThatEffectTheOptionsWhenTheMouseMoves = function (model) {
	return A4($author$project$MuchSelect$updatePartOfTheModelWithChangesThatEffectTheOptionsWhenTheMouseMoves, model.e, model.a, model.b, model);
};
		...
		var findNewSearchFilterResult = F2(
			function (optionValue, results) {
				return A2(
					$elm_community$list_extra$List$Extra$find,
					function (result) {
						return _Utils_eq(result.bS, optionValue);
					},
					results);
			});
		return A2(
			...
			function (option) {
				...
				if (!_v0.$) {
					var result = _v0.a;
					return A2($author$project$Option$setOptionSearchFilter, result.dA, option);
				} else {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				if (!_v1) {
					return $author$project$RightSlot$isRightSlotTransitioning(model.e) ? _Utils_Tuple2(model, $author$project$MuchSelect$NoEffect) : ($author$project$SelectionMode$isFocused(model.a) ? _Utils_Tuple2(model, $author$project$MuchSelect$FocusInput) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								e: A2($author$project$RightSlot$updateRightSlotTransitioning, 0, model.e),
			...
			case 2:
				return $author$project$RightSlot$isRightSlotTransitioning(model.e) ? _Utils_Tuple2(model, $author$project$MuchSelect$NoEffect) : ($author$project$SelectionMode$isFocused(model.a) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							e: A2($author$project$RightSlot$updateRightSlotTransitioning, 0, model.e),
				...
				if (!_v21.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								e: A4($author$project$RightSlot$updateRightSlot, model.e, newSelectionConfig, true, model.b),
			...
			case 37:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a9: A2($author$project$MuchSelect$ValueCasing, dims.eg, dims.dl)
						}),
					$author$project$MuchSelect$NoEffect);
			case 38:
			...
			case 44:
				...
				var _v24 = A2($elm$json$Json$Decode$decodeValue, $author$project$Option$decodeSearchResults, updatedSearchResultsJsonValue);
				if (!_v24.$) {
					var searchResults = _v24.a;
					if (_Utils_eq(searchResults.d0, model.as)) {
						var updatedOptions = A2(
							$author$project$OptionsUtilities$setAge,
							1,
							A2($author$project$OptionsUtilities$updateOptionsWithNewSearchResults, searchResults.dR, model.b));
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									b: searchResults.ds ? updatedOptions : A2(
			...
			case 45:
				...
				var _v25 = A2($elm$json$Json$Decode$decodeValue, $author$project$TransformAndValidate$customValidationResultDecoder, customValidationResultJson);
				if (!_v25.$) {
					var customValidationResult = _v25.a;
					var _v26 = A2(
					...
					switch (_v26.$) {
						...
						case 1:
							var valueString = _v26.a;
							var selectedValueIndex = _v26.b;
							var validationFailureMessages = _v26.c;
							var updatedOptions = A4(
								$author$project$OptionsUtilities$updateDatalistOptionsWithValueAndErrors,
			...
			case 46:
				...
				var _v27 = A2($elm$json$Json$Decode$decodeValue, $author$project$TransformAndValidate$decoder, transformationAndValidationJson);
				if (!_v27.$) {
					var newTransformationAndValidation = _v27.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 47:
				var _v28 = msg.a;
				var attributeName = _v28.a;
				var newAttributeValue = _v28.b;
				switch (attributeName) {
					...
					case 'max-dropdown-items':
						var _v31 = $author$project$PositiveInt$fromString(newAttributeValue);
						if (!_v31.$) {
							var maxDropdownItems = _v31.a;
							return _Utils_Tuple2(
								$author$project$MuchSelect$updateModelWithChangesThatEffectTheOptionsWhenTheSearchStringChanges(
									_Utils_update(
										model,
					...
					case 'multi-select-single-item-removal':
						return _Utils_Tuple2(
							...
							$author$project$MuchSelect$ReportReady);
					case 'option-sorting':
						var _v32 = $author$project$OptionSorting$stringToOptionSort(newAttributeValue);
						if (!_v32.$) {
							var optionSorting = _v32.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{S: optionSorting}),
					...
					case 'output-style':
						var _v33 = $author$project$SelectionMode$stringToOutputStyle(newAttributeValue);
						if (!_v33.$) {
							var outputStyle = _v33.a;
							var newSelectionConfig = A2($author$project$SelectionMode$setOutputStyle, outputStyle, model.a);
							return _Utils_Tuple2(
								_Utils_update(
									model,
				...
				switch (attributeName) {
					...
					case 'selected-value-encoding':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{aa: $author$project$SelectedValueEncoding$defaultSelectedValueEncoding}),
							$author$project$MuchSelect$NoEffect);
					case 'show-dropdown-footer':
						return _Utils_Tuple2(
							_Utils_update(
			...
			default:
				return _Utils_Tuple2(
					...
					$author$project$MuchSelect$DumpSelectionConfig(
						$author$project$SelectionMode$encodeSelectionConfig(model.a)));
		}
	});
					...
					var labelHtml = function () {
						...
						if (!_v4.$) {
							...
							return A2(
								$elm$html$Html$span,
								_List_Nil,
								$author$project$OptionPresentor$tokensToHtml(optionSearchFilter.dv));
						} else {
							return A2(
								$elm$html$Html$span,
								_List_Nil,
...
var $author$project$MuchSelect$dropdown = F4(
	function (selectionMode, options, searchString, _v0) {
		...
		var optionsHtml = $elm$core$List$isEmpty(optionsForTheDropdown) ? _List_fromArray(
			...
			{ah: $author$project$MuchSelect$DropdownMouseDownOption, ai: $author$project$MuchSelect$DropdownMouseOutOption, aj: $author$project$MuchSelect$DropdownMouseOverOption, ak: $author$project$MuchSelect$DropdownMouseUpOption, a$: $author$project$MuchSelect$NoOp},
			selectionMode,
		...
		var keyboardEvents = A2(
			...
			_List_fromArray(
				[
					...
					{z: $author$project$MuchSelect$SelectHighlightedOption, A: false, B: false}),
					_Utils_Tuple2(
					$ohanhi$keyboard$Keyboard$Backspace,
					{z: $author$project$MuchSelect$DeleteInputForSingleSelect, A: false, B: false}),
					_Utils_Tuple2(
					$ohanhi$keyboard$Keyboard$Delete,
					{z: $author$project$MuchSelect$DeleteInputForSingleSelect, A: false, B: false}),
					_Utils_Tuple2(
					$ohanhi$keyboard$Keyboard$Escape,
					{z: $author$project$MuchSelect$EscapeKeyInInputFilter, A: false, B: false}),
					_Utils_Tuple2(
					$ohanhi$keyboard$Keyboard$ArrowUp,
					{z: $author$project$MuchSelect$MoveHighlightedOptionUp, A: true, B: false}),
					_Utils_Tuple2(
					$ohanhi$keyboard$Keyboard$ArrowDown,
					{z: $author$project$MuchSelect$MoveHighlightedOptionDown, A: true, B: false})
				]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _v1 = $author$project$SelectionMode$getOutputStyle(model.a);
				if (!_v1) {
					return A4($author$project$MuchSelect$dropdown, model.a, model.b, model.g, model.a9);
				} else {
...
var $author$project$MuchSelect$main = $elm$browser$Browser$element(
	{
		...
		d8: $author$project$MuchSelect$subscriptions,
		ee: $author$project$MuchSelect$updateWrapper,
		ef: $author$project$MuchSelect$view
	});
/*
																																		...
																																		function (allowMultiSelect) {
																																			return A2(
																																				...
																																				function (allowCustomOptions) {
																																					return $elm$json$Json$Decode$succeed(
																																						{ba: allowCustomOptions, bb: allowMultiSelect, bg: customOptionHint, bi: disabled, bk: enableMultiSelectSingleItemRemoval, br: isEventsOnly, bt: loading, bu: maxDropdownItems, S: optionSort, bB: optionsJson, bC: outputStyle, bD: placeholder, bH: searchStringMinimumLength, bJ: selectedItemStaysInPlace, aa: selectedValueEncoding, bL: showDropdownFooter, bQ: transformationAndValidationJson, bS: value});
																																				},
